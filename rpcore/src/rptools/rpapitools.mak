...
$(BIN)/rpapiTest: $(rpapitestobjs)
	...
	$(LINK) -o $(BIN)/rpapiTest $(rpapitestobjs) -L$(LIB)  -lrputil -lrpcrypto
...
$(BIN)/rpapicrypUtil: $(rpapicryputilobjs)
	...
	$(LINK) -o $(BIN)/rpapicryputil $(rpapicryputilobjs) -lpthread  -L$(LIB) -lrpcrypto
...
$(BIN)/rputil: $(tobjs)
	@echo "Linking rputil ..."
	$(LINK) -o $(BIN)/rputil $(tobjs) -L$(LIB) -lrpcrypto
