...
OBJ=        $(RPROOT)/build/debug/nontpmkssobjects
...
CFLAGS=     -D FILECLIENT -D LINUX -D QUOTE2_DEFINED -D TEST -D TEST1  -D __FLUSHIO__ $(DEBUG_CFLAGS)
#CFLAGS=     -D FILECLIENT -D LINUX -D QUOTE2_DEFINED -D TEST -D __FLUSHIO__ $(RELEASE_CFLAGS)
CFLAGS1=    -D FILECLIENT -D LINUX -D QUOTE2_DEFINED -D TEST -D TEST1  -D __FLUSHIO__ $(O1RELEASE_CFLAGS)
