...
OBJ=        $(RPROOT)/build/release/nontpmkssobjects
#LIBHOME=    /home/s1
#LIB=        $(LIBHOME)/rp/lib
LIB=        $(RPROOT)/lib
INC=        $(RPROOT)/inc
...
#BIN=         ~/rp/bin/release
#OBJ=         ~/rp/build/release/keyNegoServerobjects
#LIB=         ~/rp/lib
#INC=         ../../inc
...
CFLAGS=     -D FILECLIENT -D LINUX -D QUOTE2_DEFINED  -D __FLUSHIO__ $(RELEASE_CFLAGS)
#CFLAGS=     -D FILECLIENT -D LINUX -D QUOTE2_DEFINED -D TEST -D __FLUSHIO__ $(DEBUG_CFLAGS)
CFLAGS1=    -D FILECLIENT -D LINUX -D QUOTE2_DEFINED -D __FLUSHIO__ $(O1RELEASE_CFLAGS)
...
$(BIN)/nontpmkss: $(dobjs)
	@echo "nontpmkss"
	$(LINK) -o $(BIN)/nontpmkss $(dobjs) -lpthread
