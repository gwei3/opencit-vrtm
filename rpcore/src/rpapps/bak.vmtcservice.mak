...
#OBJ=        $(RPROOT)/build/debug/vmtcServiceobjects
...
#BIN=         ~/rp/bin/release
#OBJ=         ~/rp/build/release/vmtcServiceobjects
#LIB=         ~/rp/lib
#INC=         ../../inc
...
CFLAGS=     -D TPMSUPPORT -D QUOTE2_DEFINED -D TCSERVICE -D __FLUSHIO__ $(RELEASE_CFLAGS) -DNEWANDREORGANIZED
...
all: $(BIN)/rpcoreservice

$(BIN)/rpcoreservice: $(sobjs)
	@echo "rpcoreservice"
	$(LINK) -o $(BIN)/rpcoreservice $(sobjs) $(LDFLAGS) -L$(LIB) -lrpdombldr

#$(LINK) -o $(BIN)/rpcoreservice $(sobjs) $(LDFLAGS) -lxenlight -lxlutil -lxenctrl -lxenguest -lblktapctl -lxenstore -luuid -lutil -lpthread -lrpdombldr
...
$(OBJ)/tcIO.o: $(TM)/tcIO.cpp $(S)/tcIO.h
	$(CC) $(CFLAGS) -I$(S) -I$(SC) -I$(TM) -c -o $(OBJ)/tcIO.o $(TM)/tcIO.cpp
...
$(OBJ)/taoInit.o: $(TH)/taoInit.cpp $(TH)/tao.h
	$(CC) $(CFLAGS) -I$(S) -I$(SC) -I$(SCC) -I$(SBM) -I$(TH) -I$(TS) -I$(CLM) -c -o $(OBJ)/taoInit.o $(TH)/taoInit.cpp
...
$(OBJ)/linuxHostsupport.o: $(TH)/linuxHostsupport.cpp $(TH)/linuxHostsupport.h
	$(CC) $(CFLAGS) -I$(S) -I$(SC) -I$(SCC) -I$(SBM) -I$(TH) -I$(TS) -I$(CLM) -c -o $(OBJ)/linuxHostsupport.o $(TH)/linuxHostsupport.cpp
