...
OBJ=        $(RPROOT)/build/debug/noaesnirpcorsvcobjects
...
CFLAGS=     -D NOAESNI -D TPMSUPPORT -D QUOTE2_DEFINED -D TEST -D TEST1 -D TCSERVICE -D __FLUSHIO__ $(DEBUG_CFLAGS) -DNEWANDREORGANIZED -D TPMTEST -DTEST_SEG	
...
all: $(BIN)/noaesnirpcore-g

$(BIN)/noaesnirpcore-g: $(sobjs)
	@echo "rpcoreservice"
	$(LINK) -o $(BIN)/noaesnirpcore-g $(sobjs) $(LDFLAGS) -lpthread -L$(LIB) -lrpcrypto-g -lrpmeasurer-g -lrptpm-tcsd-g -lrpchannel-g -ltspi
