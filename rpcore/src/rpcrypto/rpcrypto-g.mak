...
lobjs=      $(OBJ)/logging.o $(OBJ)/jlmcrypto.o $(OBJ)/aes.o \
	    ...
	    $(OBJ)/cryptoHelper.o $(OBJ)/cert.o $(OBJ)/quote.o

#$(OBJ)/channelcoding.o \

all: $(LIB)/librpcrypto-tcsd-g.a
...
$(OBJ)/hashprep.o: $(TPM)/hashprep.cpp $(TPM)/hashprep.h
	$(CC) $(CFLAGS) -D TEST -I$(SC) -I$(SCC) -I$(TPM) -c -o $(OBJ)/hashprep.o $(TPM)/hashprep.cpp
...
$(LIB)/librpcrypto-tcsd-g.a: $(lobjs)
	@echo "Building librpcrypto-g.a ..."
	ar cr $(LIB)/librpcrypto-g.a  $(lobjs) 
