...
B=          $(RPROOT)/build/release/signerutilobjects
...
CFLAGS=     -D LINUX  -DRPNOMAIN -DTESTQUOTE  -D TEST   -D __FLUSHIO__ $(RELEASE_CFLAGS)  
...
$(E)/signerutil: $(dobjs)
	@echo "qtest"
	$(LINK) -o $(E)/signerutil $(dobjs) $(LDFLAGS) -L$(LIB) -lpthread -lrpcrypto
