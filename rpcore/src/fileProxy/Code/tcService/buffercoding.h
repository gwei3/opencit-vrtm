...
bool  decodeTCSERVICEGETPOLICYKEYFROMOS(u32* pkeyType, int* psize,
                                        byte* key, const byte* buf);
                                        * */
int   encodeTCSERVICEGETRPHOSTQUOTEFROMAPP(int size, const byte* data, int bufsize, byte* buf);
bool  decodeTCSERVICEGETRPHOSTQUOTEFROMAPP(int* psize, byte* data, const byte* buf);
int   encodeTCSERVICEGETRPHOSTQUOTEFROMTCSERVICE(int size, const byte* data, int bufsize, byte* buf);
bool  decodeTCSERVICEGETRPHOSTQUOTEFROMTCSERVICE(int* psize, byte* data, const byte* buf);


int   encodeTCSERVICERPHOSTQUOTERESPONSEFROMAPP(int size, const byte* data, int bufsize, byte* buf);
bool  decodeTCSERVICERPHOSTQUOTERESPONSEFROMAPP(int* psize, byte* data, const byte* buf);
int   encodeTCSERVICERPHOSTQUOTERESPONSEFROMTCSERVICE(int size, const byte* data, int bufsize, byte* buf);
bool  decodeTCSERVICERPHOSTQUOTERESPONSEFROMTCSERVICE(int* psize, byte* data, const byte* buf);
...
bool  encodeTCSERVICEGETOSCREDSFROMAPP(u32 credType, int size, const byte* cred, byte* buf);
...
bool  encodeTCSERVICEGETOSCERTFROMAPP(u32 credType, int size, const byte* cred, byte* buf);
int   encodeTCSERVICEGETOSCERTFROMTCSERVICE(u32 hashType, int size, 
                                    const byte* hash, int bufsize, byte* buf);
bool  decodeTCSERVICEGETOSCERTFROMTCSERVICE(u32* phashType, int* psize, 
                                    byte* hash, const byte* buf);
bool  decodeTCSERVICEGETOSCERTFROMAPP(u32* pcredType, int* psize, byte* cred, 
                                    const byte* buf);
                                    

int   encodeTCSERVICESETFILEFROMAPP(int size, const byte* data, int bufsize, byte* buf);
bool  decodeTCSERVICESETFILEFROMAPP(int* psize, byte* data, const byte* buf);
int   encodeTCSERVICESETFILEFROMTCSERVICE(int size, const byte* data, int bufsize, byte* buf);
bool  decodeTCSERVICESETFILEFROMTCSERVICE(int* psize, byte* data, const byte* buf);
