...
lobjs=      $(B)/logging.o $(B)/jlmcrypto.o $(B)/jlmUtility.o \
	    $(B)/keys.o $(B)/aesni.o $(B)/sha256.o  $(B)/sha1.o \
            $(B)/hmacsha256.o $(B)/mpBasicArith.o $(B)/mpModArith.o $(B)/hashprep.o \
	    $(B)/mpNumTheory.o  $(B)/cryptoHelper.o $(B)/quote.o $(B)/cert.o  \
	     $(B)/modesandpadding.o $(B)/validateEvidence.o \
	    $(B)/tinystr.o $(B)/tinyxmlerror.o $(B)/tinyxml.o $(B)/tinyxmlparser.o \
	    $(B)/fastArith.o $(B)/encryptedblockIO.o 
#$(B)/keyNegoServer.o $(B)/channel.o 

#v: $(B)/resource.o

all: $(LIB)/librptrust.a

#$(B)/keyNegoServer.o: $(S)/keyNegoServer.cpp $(S)/keyNegoServer.h
#	$(CC) $(CFLAGS) -I$(S) -I$(TRS)  -I$(TPD) -I$(VLT) -I$(SC) -I$(TH) -I$(SCC) -I$(BSC) -I$(CH) -I$(CLM) -c -o $(B)/keyNegoServer.o $(S)/keyNegoServer.cpp
...
$(B)/quote.o: $(CLM)/quote.cpp $(CLM)/quote.h
	$(CC) $(CFLAGS) -I$(S) -I$(SC) -I$(SCC) -I$(BSC) -I$(VLT)  -I$(TPD) -I$(CLM) -I$(TH) -c -o $(B)/quote.o $(CLM)/quote.cpp
...
$(LIB)/librptrust.a: $(lobjs)
	@echo "Building librpcrypto.a ..."
	ar cr $(LIB)/librptrust.a  $(lobjs) 
