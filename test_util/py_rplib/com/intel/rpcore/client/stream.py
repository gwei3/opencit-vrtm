...
class TCBuffer(object):
    ...
    def __init__(self, m_procid = 0, m_reqID = 0, 
                       m_reqSize = 0, 
                       m_ustatus = 0,
                       m_origprocid = 0):
        """
            m_reqID and m_reqSize are mandatory arguments for making rpcore request.
    ...
    def get_m_procid(self):
        return self.__m_procid

    def set_m_procid(self, m_procid):
        self.__m_procid = m_procid
    ...
    def get_orig_procid(self):
        return self.__m_procid

    def set_orig_procid(self, m_procid):
        self.__m_procid = m_procid
