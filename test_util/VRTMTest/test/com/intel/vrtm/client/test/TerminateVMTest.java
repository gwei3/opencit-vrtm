...
public class TerminateVMTest {
	static final String xmlRPCBlob=  "<?xml version='1.0'?>" 
			   + "<methodCall>"
			   + "<methodName>terminate_app</methodName>"
			   + 	"<params>"
			   +		"<param>"
	 ...
	 * 
	 * @param args
	 *            : args[0] : RPCore IP Address. args[1] : RPCore Port args[2] :
	 *            VMUUID, You will get VMUUID from OpenStack Horizon
	 * 
	 * @throws IOException
	 */
	public static void main(String[] args) throws IOException {
		// Get TCBuffer Objct for required call
		TCBuffer tcBuffer = Factory.newTCBuffer(RPCCall.TERMINATE_APP);
