...
#                             self.uri())
    ...
    def destroy(self, instance, network_info, block_device_info=None,
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Destroying instance: instance=%s, block_device=%s", jsonutils.dumps(instance), jsonutils.dumps(block_device_info))
        # jbuhacoff end
        self._destroy(instance)
    ...
    def _cleanup(self, instance, network_info, block_device_info,
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Cleaning instance: %s", jsonutils.dumps(instance))
        # jbuhacoff end
    ...
    def snapshot(self, context, instance, image_href, update_task_state):
        # jbuhacoff start
        LOG.debug("mhagent hook: Snapshot instance: %s", jsonutils.dumps(instance));
        # jbuhacoff end
    ...
    def reboot(self, context, instance, network_info, reboot_type='SOFT',
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Reboot instance: %s", jsonutils.dumps(instance))
        # jbuhacoff end
    ...
    def pause(self, instance):
        """Pause VM instance."""
        # jbuhacoff start
        LOG.debug("mhagent hook: Pausing instance: %s", jsonutils.dumps(instance))
        #subprocess.call(['/usr/local/bin/mhagent','log','pausing uuid: '+instance['uuid'], 'instance hostname: '+instance['hostname'],'project id: '+instance['project_id'],'host: '+instance['host'],'instance name: '+instance['name']])
        #subprocess.call(['/usr/local/bin/mhagent','pause', '--project-id='+instance['project_id'], '--instance-name='+instance['name']])
        # jbuhacoff end
        dom = self._lookup_by_name(instance['name'])
        dom.suspend()
    ...
    def unpause(self, instance):
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Resuming paused instance: %s", jsonutils.dumps(instance))
        #subprocess.call(['/usr/local/bin/mhagent','log','resuming paused uuid: '+instance['uuid'], 'instance hostname: '+instance['hostname'],'project id: '+instance['project_id'],'host: '+instance['host'],'instance name: '+instance['name']])
        #subprocess.call(['/usr/local/bin/mhagent','pause-resume', '--project-id='+instance['project_id'], '--instance-name='+instance['name']])
        # jbuhacoff end
        dom = self._lookup_by_name(instance['name'])
        dom.resume()
    ...
    def power_off(self, instance):
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Power-off (destroy) instance: %s", jsonutils.dumps(instance))
        #subprocess.call(['/usr/local/bin/mhagent','log','poweroff uuid: '+instance['uuid'], 'instance hostname: '+instance['hostname'],'project id: '+instance['project_id'],'host: '+instance['host'],'instance name: '+instance['name']])
        # jbuhacoff end
        self._destroy(instance)
    ...
    def power_on(self, context, instance, network_info,
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Power-on instance: %s", jsonutils.dumps(instance))
        #subprocess.call(['/usr/local/bin/mhagent','log','poweron uuid: '+instance['uuid'], 'instance hostname: '+instance['hostname'],'project id: '+instance['project_id'],'host: '+instance['host'],'instance name: '+instance['name']])
        # jbuhacoff end
    ...
    def suspend(self, instance):
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Suspending instance: %s", jsonutils.dumps(instance))
        #subprocess.call(['/usr/local/bin/mhagent','log','suspending uuid: '+instance['uuid'], 'instance hostname: '+instance['hostname'],'project id: '+instance['project_id'],'host: '+instance['host'],'instance name: '+instance['name']])
        #subprocess.call(['/usr/local/bin/mhagent','suspend', '--project-id='+instance['project_id'], '--instance-name='+instance['name']])
        # jbuhacoff end
        dom = self._lookup_by_name(instance['name'])
    ...
    def resume(self, instance, network_info, block_device_info=None):
        ...
        # jbuhacoff start
        LOG.debug("mhagent hook: Resuming suspended instance: %s", jsonutils.dumps(instance))
        #subprocess.call(['/usr/local/bin/mhagent','log','resuming from suspended uuid: '+instance['uuid'], 'instance hostname: '+instance['hostname'],'project id: '+instance['project_id'],'host: '+instance['host'],'instance name: '+instance['name']])
        #subprocess.call(['/usr/local/bin/mhagent','suspend-resume', '--project-id='+instance['project_id'], '--instance-name='+instance['name']])
        # jbuhacoff end
    ...
    def _create_image(self, context, instance,
        ...
        # MH start of mhagent hook for kernel/ramdisk download and decryption
        if disk_images['kernel_id']:
            ...
            if 'properties' in kernel_meta and 'mh_encrypted' in kernel_meta['properties']:
                instance['mh_encrypted'] = kernel_meta['properties']['mh_encrypted']
                instance['mh_checksum'] = kernel_meta['properties']['mh_checksum']
                instance['mh_dek_url'] = kernel_meta['properties']['mh_dek_url']
            ...
            raw('kernel').cache(fetch_func=libvirt_utils.fetch_image,
                                ...
                                instance=instance, # jbuhacoff added instance parameter
            ...
            if disk_images['ramdisk_id']:
                ...
                if 'properties' in ramdisk_meta and 'mh_encrypted' in ramdisk_meta['properties']:
                    instance['mh_encrypted'] = ramdisk_meta['properties']['mh_encrypted']
                    instance['mh_checksum'] = ramdisk_meta['properties']['mh_checksum']
                    instance['mh_dek_url'] = ramdisk_meta['properties']['mh_dek_url']
        ...
        # MH end of mhagent hook for kernel/ramdisk download and decryption
    ...
    def _fetch_instance_kernel_ramdisk(self, context, instance):
        ...
        if instance['kernel_id']:
            libvirt_utils.fetch_image(context,
                                      ...
                                      instance['kernel_id'],
                                      instance, # jbuhacoff added instance parameter
                                      instance['user_id'],
                                      instance['project_id'])
            if instance['ramdisk_id']:
                libvirt_utils.fetch_image(context,
