...
""" Adding is_measured field to the horizon dashboard. """
class SetInstanceDetailsAction(workflows.Action):
    is_measured = forms.BooleanField(label=_("Measured Launch"), required=False)
...
class LaunchInstance(workflows.Workflow):
    ...
    def handle(self, request, context):
        ...
        """ Passing the is_measured flag to the create request. """
        try:
