...
class CommonDeserializer(wsgi.MetadataXMLDeserializer):
    ...
    def _extract_server(self, node):
        ...
        """ Adding is_measured flag to the server attribute. """
...
class Controller(wsgi.Controller):
    ...
    def create(self, req, body):
        ...
        """ Retrieving is_measured flag value from the server attributes. """ 	
	is_measured = server_dict['is_measured']
        ...
        try:
            ...
            """ Providing is_measured flag in the create request. """
