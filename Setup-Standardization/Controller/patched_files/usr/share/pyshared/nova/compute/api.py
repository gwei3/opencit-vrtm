...
class API(base.Base):
    ...
    """ Addition of is_measured flag in the parameters for validation. """
    def _validate_and_build_base_options(self, context, instance_type,
        ...
        """ Adding is_measured flag in the base options. """
        base_options = {
    ...
    """ Modification in the method to include is_measured flag in the arguments. """
    def _create_instance(self, context, instance_type,
        ...
        """ Passing is_measured flag for validation along with other parameters. """
    ...
    """ Including is_measured as argument to the method. """
    ...
    def create(self, context, instance_type,
        ...
        """ Passing is_measured flag to the method along with other parameters. """
