...
class ServerManager(base.BootingManagerWithFind):
    ...
    """ Modifying the create request to accomodate the is_measured flag and pass it to the boot parameters. """
    def create(self, name, image, flavor, meta=None, files=None,
        ...
        :param is_measured: Boot server as measured or non-mesaured.
